            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        table, as shown in this example. <strong>Datatables support all available table styling.</strong>
                    </div>
...
{{--
                                                    ...
                                                    <button type="submit" class="btn bg-transparent dropdown-item"><i class="icon-file-word"></i> Delete</button>
