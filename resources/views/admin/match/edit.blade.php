                    ...
                    <form action="{{ route('match.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="mb-3">
                            ...
                            <div class="form-group  form-group-float">
                                ...
                                <select data-placeholder="Select Match Type" name="match_type_id" class="form-control">
                                    <option>--</option>
                                    @forelse ($matchTypes as $matchType)
                                        <option value="{{ $matchType->id }}"
                                            {{ $matchType->name == $matchType->name ? 'selected' : '' }}>
                                            {{ $matchType->name }}</option>
                                    @empty
                            ...
                            <div class="form-group form-group-float d-flex">
                                <div class="col-md-5">
                                    ...
                                    <select data-placeholder="Select Team 1" name="team_1" class="form-control">
                                        <option>--</option>
                                        @forelse ($team1 as $teamOne)
                                            <option value="{{ $teamOne->id }}"
                                                {{ $teamOne->name == $teamOne->name ? 'selected' : '' }}>
                                                {{ $teamOne->title }}</option>
                                        @empty
                                            <option> No Data Found</option>
                                        @endforelse
                                    </select>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select data-placeholder="Select Team 2" name="team_2" class="form-control">
                                        <option>--</option>
                                        @forelse ($team2 as $teamTwo)
                                        <option value="{{ $teamTwo->id }}"  {{ $teamTwo->name == $teamTwo->name ? 'selected' : '' }}>{{ $teamTwo->title }}</option>
                                    @empty
                                        <option> No Data Found</option>
                                    @endforelse
                                    </select>
                            ...
                            <div class="form-group  form-group-float">
                                ...
                                <input type="date" value="{{ old('date', $match->date) }}" name="date"
                                    class="form-control" placeholder="Enter date...">
                            </div>

                            <div class="form-group  form-group-float">
                                <label class="d-block">Start time</label>
                                <input type="time" value="{{ old('match_start_time', $match->match_start_time) }}"
                                    name="match_start_time" class="form-control" placeholder="Enter match_start_time...">
                            </div>

                            <div class="form-group  form-group-float">
                                <label class="d-block">End time</label>
                                <input type="time" value="{{ old('match_end_time', $match->match_end_time) }}"
                                    name="match_end_time" class="form-control" placeholder="Enter match_end_time...">
                            </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" value="{{ old('team_1_score', $match->team_1_score) }}"
                                            name="team_1_score" class="form-control" placeholder="Enter Team 1 score...">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group  form-group-float">
                                            ...
                                            <select data-placeholder="Select Match Type" name="team_1_match_result"
                                                class="form-control">
                                                <option>--</option>
                                                <option value="win" {{ $match->team_1_match_result == 'win' ? 'selected' : '' }}>Winner</option>
                                                <option value="loss" {{ $match->team_1_match_result == 'loss' ? 'selected' : '' }}>Losser</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_heading_1', $match->team_1_matchup_heading_1) }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_title_1', $match->team_1_matchup_title_1) }}"
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_heading_2', $match->team_1_matchup_heading_2) }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_title_2', $match->team_1_matchup_title_2) }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_heading_3', $match->team_1_matchup_heading_3) }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('team_1_matchup_title_3', $match->team_1_matchup_title_3) }}"
                            ...
                            <fieldset>
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" value="{{ old('team_2_score', $match->team_2_score) }}"
                                            name="team_2_score" class="form-control" placeholder="Enter Team 2 score...">
                                    </div>
                                    <div class="col-md-3">

                                        <div class="form-group  form-group-float">
                                            <label class="d-block">Team 2 Match Result</label>
                                            <select data-placeholder="Select team_2_match_result" name="team_2_match_result"
                                                class="form-control">
                                                <option>--</option>
                                                <option value="win" {{ $match->team_2_match_result == 'win' ? 'selected' : '' }}>Winner</option>
                                                <option value="loss" {{ $match->team_2_match_result == 'loss' ? 'selected' : '' }}>Losser</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Heading 1</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_heading_1', $match->team_2_matchup_heading_1) }}"
                                    ...
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Title 1</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_title_1', $match->team_2_matchup_title_1) }}"
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Heading 2</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_heading_2', $match->team_2_matchup_heading_2) }}"
                                    ...
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Title 2</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_title_2', $match->team_2_matchup_title_2) }}"
                                    ...
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Heading 3</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_heading_3', $match->team_2_matchup_heading_3) }}"
                                    ...
                                    <div class="col-md-3">
                                        <label class="d-block">Team Matchup Title 3</label>
                                        <input type="text"
                                            value="{{ old('team_2_matchup_title_3', $match->team_2_matchup_title_3) }}"
                            ...
                            <fieldset>
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_map_heading', $match->general_stats_map_heading) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_map_title', $match->general_stats_map_title) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_mission_heading', $match->general_stats_mission_heading) }}"
                                ...
                                <div class="form-group col-md-12 form-group-float d-flex">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_mission_title', $match->general_stats_mission_title) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_duration_heading', $match->general_stats_duration_heading) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            value="{{ old('general_stats_duration_title', $match->general_stats_duration_title) }}"
