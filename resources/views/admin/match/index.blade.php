    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-md-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">matchs</span></h4>
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="{{ route('match.index') }}" class="breadcrumb-item">match</a>
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body ">
                        <a class="btn btn-primary float-right" href="{{ route('match.create') }}"> Add
                            New match</a>
                    </div>
                        ...
                        <tbody>
                            @forelse($matches as $key => $match)
                                <tr>
                                    ...
                                    <td>{{ $match->team1[0]->title . '  vs  ' . $match->team2[0]->title }}</td>
                                    <td>{{ $match->date }}</td>
